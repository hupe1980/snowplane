...
// GetConditions returns the conditions of the Database.
func (d *Database) GetConditions() []metav1.Condition {
	return d.Status.Conditions
}

// SetConditions sets the conditions of the Database.
...
func (d *Database) GetSpecName() string { return d.Spec.Name }

// GetProviderRef returns the provider reference from the spec.
func (d *Database) GetProviderRef() ProviderReference { return d.Spec.ProviderRef }

// GetUseRole returns the use role from the spec.
func (d *Database) GetUseRole() *string { return d.Spec.UseRole }

// GetObservedGeneration returns the observed generation from status.
func (d *Database) GetObservedGeneration() int64 { return d.Status.ObservedGeneration }

// SetObservedGeneration sets the observed generation in status.
func (d *Database) SetObservedGeneration(v int64) { d.Status.ObservedGeneration = v }

// GetLastAppliedSpecHash returns the last applied spec hash from status.
func (d *Database) GetLastAppliedSpecHash() string { return d.Status.LastAppliedSpecHash }

// SetLastAppliedSpecHash sets the last applied spec hash in status.
func (d *Database) SetLastAppliedSpecHash(v string) { d.Status.LastAppliedSpecHash = v }

// GetTrackedParametersList returns the tracked parameters list from status.
func (d *Database) GetTrackedParametersList() []string { return d.Status.TrackedParameters }

// SetTrackedParametersList sets the tracked parameters list in status.
func (d *Database) SetTrackedParametersList(v []string) { d.Status.TrackedParameters = v }
...
func (d *Database) ValidateSpec() error { return d.Spec.Validate() }

// ComputeSpecHash returns a SHA-256 hash of the spec for drift detection.
func (d *Database) ComputeSpecHash() (string, error) { return ComputeSpecHash(d.Spec) }
