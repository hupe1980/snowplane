...
const (
	...
	// Schema, Table, Warehouse, Task, Tag, FileFormat, MaskingPolicy,
	// PasswordPolicy, NetworkRule, RowAccessPolicy, User, View).
	// Set to "false" to opt out and use the legacy two-step flow.
	// For unsupported types the annotation is ignored.
