...
// StreamOnExternalTableSpec defines the desired state of a Snowflake Stream on an External Table.
//
...
// StreamOnExternalTableStatus defines the observed state of a StreamOnExternalTable.
...
type StreamOnExternalTable struct {
	...
	Spec   StreamOnExternalTableSpec   `json:"spec,omitempty"`
	Status StreamOnExternalTableStatus `json:"status,omitempty"`
}

// StreamOnExternalTableList contains a list of StreamOnExternalTable.
// +kubebuilder:object:root=true
type StreamOnExternalTableList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []StreamOnExternalTable `json:"items"`
}

func init() {
	SchemeBuilder.Register(&StreamOnExternalTable{}, &StreamOnExternalTableList{})
}
