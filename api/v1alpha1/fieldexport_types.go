...
// +kubebuilder:validation:XValidation:rule="self.from.resource.kind in ['Alert','AuthenticationPolicy','Database','Schema','Warehouse','User','AccountRole','DatabaseRole','GrantPrivilegesToAccountRole','GrantPrivilegesToDatabaseRole','GrantPrivilegesToShare','AccountRoleAssignment','DatabaseRoleAssignment','TagAssociation','NetworkPolicyAttachment','PasswordPolicyAttachment','MaskingPolicyApplication','TableConstraint','Table','View','ExternalStage','InternalStage','Task','StreamOnTable','StreamOnView','StreamOnExternalTable','StreamOnDirectoryTable','StreamOnDynamicTable','Tag','NetworkPolicy','ResourceMonitor','MaskingPolicy','RowAccessPolicy','GrantOwnership','StorageIntegrationAWS','StorageIntegrationGCS','StorageIntegrationAzure','EmailNotificationIntegration','QueueNotificationIntegration','WebhookNotificationIntegration','FileFormat','Pipe','DynamicTable','PasswordPolicy','NetworkRule','Sequence','ExternalTable','MaterializedView','ProcedureSQL','ProcedureJavascript','ProcedurePython','ProcedureJava','ProcedureScala','FunctionSQL','FunctionJavascript','FunctionPython','FunctionJava','FunctionScala','SecretWithClientCredentials','SecretWithAuthorizationCodeGrant','SecretWithBasicAuthentication','SecretWithGenericString','APIAuthenticationIntegrationWithClientCredentials','APIAuthenticationIntegrationWithAuthorizationCodeGrant','APIAuthenticationIntegrationWithJWTBearer','SAML2Integration','ExternalOAuthIntegration','SCIMIntegration','APIIntegration','SecondaryDatabase','SharedDatabase','FailoverGroup','SQLStatement','Share','ExternalFunction','ComputePool','Service','ImageRepository','ExternalVolume','CortexSearchService','GitRepository','Streamlit','OAuthIntegrationForCustomClients','OAuthIntegrationForPartnerApplications','PrimaryConnection','SecondaryConnection']",message="spec.from.resource.kind must be a supported Snowplane resource kind"
