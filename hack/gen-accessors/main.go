...
var types = []TypeDef{
	...
	// OAuth Integrations (account-level, no owner)
	{TypeName: "OAuthIntegrationForCustomClients", Receiver: "occ", Owner: OwnerEmpty, OwnerComment: "SHOW SECURITY INTEGRATIONS does not return an owner column.", TrackedParams: TrackedParamsFromStatus},
	{TypeName: "OAuthIntegrationForPartnerApplications", Receiver: "opa", Owner: OwnerEmpty, OwnerComment: "SHOW SECURITY INTEGRATIONS does not return an owner column.", TrackedParams: TrackedParamsFromStatus},

	// Connections (account-level, no owner)
	{TypeName: "PrimaryConnection", Receiver: "pc", Owner: OwnerEmpty, OwnerComment: "SHOW CONNECTIONS does not return an owner column.", TrackedParams: TrackedParamsFromStatus},
	{TypeName: "SecondaryConnection", Receiver: "sc", Owner: OwnerEmpty, OwnerComment: "SHOW CONNECTIONS does not return an owner column.", TrackedParams: TrackedParamsFromStatus},
}
