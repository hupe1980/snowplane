...
func TestGeneratedMethodCount(t *testing.T) {
	...
	// 14 A1 types × 16 methods + 3 A3 types × 16 methods + 3 A2 types × 16 methods + 3 B types × 15 methods + 1 C type × 15 methods = 380
	assert.Equal(t, 380, methodCount, "expected 380 accessor methods across 24 types")
}

// TestGeneratedTypeHeaders verifies all 24 types have section headers.
