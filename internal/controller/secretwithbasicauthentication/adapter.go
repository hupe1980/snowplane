...
func (a *adapter) ResourceName() string  { return "secretwithbasicauthentication" }
func (a *adapter) FinalizerName() string { return finalizerName }
func (a *adapter) NewObject() *snowplanev1alpha1.SecretWithBasicAuthentication {
...
func (a *adapter) PreReconcile(ctx context.Context, obj *snowplanev1alpha1.SecretWithBasicAuthentication) error {
...
func (a *adapter) BuildIdentifier(obj *snowplanev1alpha1.SecretWithBasicAuthentication) (reconciler.Identifier, error) {
...
func (a *adapter) SetupWatches() reconciler.SetupWatchesFunc {
	return func(ctx context.Context, mgr ctrl.Manager, bldr *builder.Builder) error {
		...
		bldr.Watches(&snowplanev1alpha1.Database{},
			handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(a.client, func() sigs.ObjectList { return &snowplanev1alpha1.SecretWithBasicAuthenticationList{} }, ".spec.databaseRef.name", "listing secrets for database watch")))
		bldr.Watches(&snowplanev1alpha1.Schema{},
			handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(a.client, func() sigs.ObjectList { return &snowplanev1alpha1.SecretWithBasicAuthenticationList{} }, ".spec.schemaRef.name", "listing secrets for schema watch")))
...
func (a *adapter) Create(ctx context.Context, svc Service, obj *snowplanev1alpha1.SecretWithBasicAuthentication, id reconciler.Identifier) error {
	sid, err := reconciler.AssertIdentifier[snowflake.SchemaObjectIdentifier](id)
	if err != nil {
		return err
	}

	return svc.Create(ctx, buildCreateOptions(obj, sid))
}
...
func (a *adapter) ValidateImmutableFields(_ context.Context, obj *snowplanev1alpha1.SecretWithBasicAuthentication) error {
...
func (a *adapter) BuildAlterOptions(_ context.Context, obj *snowplanev1alpha1.SecretWithBasicAuthentication, id reconciler.Identifier, obs *reconciler.Observation[*snowflake.SecretObservation]) (reconciler.AlterOptions, error) {
	sid, err := reconciler.AssertIdentifier[snowflake.SchemaObjectIdentifier](id)
	if err != nil {
		return nil, err
	}
...
func (a *adapter) ApplyObservation(obj *snowplanev1alpha1.SecretWithBasicAuthentication, obs *reconciler.Observation[*snowflake.SecretObservation]) {
	applyObservation(obj, obs.Detail)
}

func (a *adapter) ComputeTrackedParameters(obj *snowplanev1alpha1.SecretWithBasicAuthentication) []string {
	return tracked.ComputeTracked(&obj.Spec)
}

func (a *adapter) DetectDrift(obj *snowplanev1alpha1.SecretWithBasicAuthentication, obs *reconciler.Observation[*snowflake.SecretObservation]) *drift.Result {
	return detectDrift(obj, obs.Detail)
}

var _ reconciler.ResourceAdapter[*snowplanev1alpha1.SecretWithBasicAuthentication, Service, *snowflake.SecretObservation] = (*adapter)(nil)
