...
type mockService struct {
	observeFn func(ctx context.Context, name snowflake.SchemaObjectIdentifier) (*snowflake.ExternalStageObservation, error)
	createFn  func(ctx context.Context, opts snowflake.CreateExternalStageOptions) error
	alterFn   func(ctx context.Context, opts snowflake.AlterExternalStageOptions) error
	dropFn    func(ctx context.Context, name snowflake.SchemaObjectIdentifier) error
}

func (m *mockService) Observe(ctx context.Context, name snowflake.SchemaObjectIdentifier) (*snowflake.ExternalStageObservation, error) {
	if m.observeFn != nil {
		return m.observeFn(ctx, name)
	}
	return &snowflake.ExternalStageObservation{Exists: false}, nil
}

func (m *mockService) Create(ctx context.Context, opts snowflake.CreateExternalStageOptions) error {
	if m.createFn != nil {
...
func (m *mockService) Alter(ctx context.Context, opts snowflake.AlterExternalStageOptions) error {
	if m.alterFn != nil {
...
func newTestExternalStage(name, ns string) *snowplanev1alpha1.ExternalStage {
...
func newTestReconciler(mock *mockService, objs ...runtime.Object) *reconciler.GenericReconciler[*snowplanev1alpha1.ExternalStage, Service, *snowflake.ExternalStageObservation] {
	...
	r.GVK = snowplanev1alpha1.GroupVersion.WithKind("ExternalStage")
...
func TestReconcile_StandardSuite(t *testing.T) {
	...
	testutil.ReconcileSuiteConfig{
		...
		NewFixture: func(name, ns string) client.Object {
			return newTestExternalStage(name, ns)
		},
