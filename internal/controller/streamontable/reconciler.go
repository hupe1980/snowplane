// Package streamontable implements the reconciler for StreamOnTable resources.
...
const (
	finalizerName = "snowplane.hupe1980.github.io/streamontable"
)
...
// NewReconciler returns a new StreamOnTable reconciler backed by the generic framework.
func NewReconciler(c sigs.Client, factory *clientfactory.ClientFactory, recorder record.EventRecorder, rl *ratelimit.Limiter) *reconciler.GenericReconciler[*snowplanev1alpha1.StreamOnTable, Service, *snowflake.StreamObservation] {
...
func NewReconcilerWithServiceFactory(
	...
	sf ServiceFactory,
) *reconciler.GenericReconciler[*snowplanev1alpha1.StreamOnTable, Service, *snowflake.StreamObservation] {
	return reconciler.NewGenericReconciler(c, factory, recorder, rl, newAdapter(c, recorder, sf))
}

// newAdapter creates the BaseAdapter for StreamOnTable resources.
func newAdapter(c sigs.Client, recorder record.EventRecorder, sf ServiceFactory) *reconciler.BaseAdapter[*snowplanev1alpha1.StreamOnTable, Service, *snowflake.StreamObservation] {
	return &reconciler.BaseAdapter[*snowplanev1alpha1.StreamOnTable, Service, *snowflake.StreamObservation]{
		ResourceNameVal:  "streamontable",
		FinalizerNameVal: finalizerName,
		NewObjectFn:      func() *snowplanev1alpha1.StreamOnTable { return &snowplanev1alpha1.StreamOnTable{} },
		ServiceFactoryFn: sf,
		BuildIdentifierFn: func(obj *snowplanev1alpha1.StreamOnTable) (reconciler.Identifier, error) {
		...
		CreateFn: reconciler.MakeCreate(func(ctx context.Context, svc Service, obj *snowplanev1alpha1.StreamOnTable, id snowflake.SchemaObjectIdentifier) error {
		...
		BuildAlterOptsFn: reconciler.MakeBuildAlterOpts(func(_ context.Context, obj *snowplanev1alpha1.StreamOnTable, id snowflake.SchemaObjectIdentifier, obs *reconciler.Observation[*snowflake.StreamObservation]) (reconciler.AlterOptions, error) {
			opts := buildAlterOptions(obj, id, obs.Detail)
			return &opts, nil
		}),
		ApplyObservationFn: func(obj *snowplanev1alpha1.StreamOnTable, obs *reconciler.Observation[*snowflake.StreamObservation]) {
			applyObservation(obj, obs.Detail)
		},
		DetectDriftFn: func(obj *snowplanev1alpha1.StreamOnTable, obs *reconciler.Observation[*snowflake.StreamObservation]) *drift.Result {
			return detectDrift(obj, obs.Detail)
		},
		PreReconcileFn: func(ctx context.Context, obj *snowplanev1alpha1.StreamOnTable) error {
			...
			tableName, err := refresolver.PreReconcileSourceRef(ctx, c, recorder, obj,
		...
		SetupWatchesFn: func(ctx context.Context, mgr ctrl.Manager, bldr *builder.Builder) error {
			...
			bldr.Watches(
				...
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.StreamOnTableList{} }, ".spec.databaseRef.name", "listing stream-on-table for database watch")),
			)

			bldr.Watches(
				&snowplanev1alpha1.Schema{},
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.StreamOnTableList{} }, ".spec.schemaRef.name", "listing stream-on-table for schema watch")),
			)
			...
			bldr.Watches(
				...
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.StreamOnTableList{} }, ".spec.tableRef.name", "listing stream-on-table for table watch")),
			)
...
func validateImmutableFields(_ context.Context, obj *snowplanev1alpha1.StreamOnTable) error {
...
func applyObservation(obj *snowplanev1alpha1.StreamOnTable, obs *snowflake.StreamObservation) {
...
func buildCreateOptions(obj *snowplanev1alpha1.StreamOnTable, id snowflake.SchemaObjectIdentifier) snowflake.CreateStreamOptions {
...
func buildAlterOptions(obj *snowplanev1alpha1.StreamOnTable, id snowflake.SchemaObjectIdentifier, obs *snowflake.StreamObservation) snowflake.AlterStreamOptions {
...
func detectDrift(obj *snowplanev1alpha1.StreamOnTable, obs *snowflake.StreamObservation) *drift.Result {
	d := drift.New()
