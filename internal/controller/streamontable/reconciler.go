...
func NewReconciler(c client.Client, factory *clientfactory.ClientFactory, recorder record.EventRecorder, rl *ratelimit.Limiter) *reconciler.GenericReconciler[*snowplanev1alpha1.StreamOnTable, Service, *snowflake.StreamObservation] {
...
func computeUnsetFields(obj *snowplanev1alpha1.StreamOnTable) []string {
...
func computeTrackedParameters(spec *snowplanev1alpha1.StreamOnTableSpec) []string {
	var fields []string
