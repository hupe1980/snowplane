...
func newTestStreamOnView(name, namespace string) *snowplanev1alpha1.StreamOnView {
...
func newTestReconciler(mock *mockService, objs ...runtime.Object) *reconciler.GenericReconciler[*snowplanev1alpha1.StreamOnView, Service, *snowflake.StreamObservation] {
	scheme := testutil.TestScheme()
	cb := fake.NewClientBuilder().WithScheme(scheme).
		WithStatusSubresource(&snowplanev1alpha1.StreamOnView{}, &snowplanev1alpha1.ProviderConfig{})
...
func TestReconcile_StandardSuite(t *testing.T) {
	...
	testutil.ReconcileSuiteConfig{
		...
		NewFixture: func(name, ns string) client.Object {
			return newTestStreamOnView(name, ns)
		},
...
func TestReconcile_Create(t *testing.T) {
	...
	assert.Equal(t, snowflake.StreamSourceView, capturedOpts.SourceType)
	assert.Equal(t, "MY_VIEW", capturedOpts.SourceName)
	got := &snowplanev1alpha1.StreamOnView{}
...
func TestBuildCreateOptions(t *testing.T) {
	...
	assert.Equal(t, snowflake.StreamSourceView, opts.SourceType)
	assert.Equal(t, "MY_VIEW", opts.SourceName)
