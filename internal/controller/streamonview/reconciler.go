// Package streamonview implements the reconciler for StreamOnView resources.
...
const (
	finalizerName = "snowplane.hupe1980.github.io/streamonview"
)
...
// NewReconciler returns a new StreamOnView reconciler backed by the generic framework.
func NewReconciler(c sigs.Client, factory *clientfactory.ClientFactory, recorder record.EventRecorder, rl *ratelimit.Limiter) *reconciler.GenericReconciler[*snowplanev1alpha1.StreamOnView, Service, *snowflake.StreamObservation] {
...
func NewReconcilerWithServiceFactory(
	...
	sf ServiceFactory,
) *reconciler.GenericReconciler[*snowplanev1alpha1.StreamOnView, Service, *snowflake.StreamObservation] {
	return reconciler.NewGenericReconciler(c, factory, recorder, rl, newAdapter(c, recorder, sf))
}

// newAdapter creates the BaseAdapter for StreamOnView resources.
func newAdapter(c sigs.Client, recorder record.EventRecorder, sf ServiceFactory) *reconciler.BaseAdapter[*snowplanev1alpha1.StreamOnView, Service, *snowflake.StreamObservation] {
	return &reconciler.BaseAdapter[*snowplanev1alpha1.StreamOnView, Service, *snowflake.StreamObservation]{
		ResourceNameVal:  "streamonview",
		FinalizerNameVal: finalizerName,
		NewObjectFn:      func() *snowplanev1alpha1.StreamOnView { return &snowplanev1alpha1.StreamOnView{} },
		ServiceFactoryFn: sf,
		BuildIdentifierFn: func(obj *snowplanev1alpha1.StreamOnView) (reconciler.Identifier, error) {
		...
		CreateFn: reconciler.MakeCreate(func(ctx context.Context, svc Service, obj *snowplanev1alpha1.StreamOnView, id snowflake.SchemaObjectIdentifier) error {
		...
		BuildAlterOptsFn: reconciler.MakeBuildAlterOpts(func(_ context.Context, obj *snowplanev1alpha1.StreamOnView, id snowflake.SchemaObjectIdentifier, obs *reconciler.Observation[*snowflake.StreamObservation]) (reconciler.AlterOptions, error) {
			opts := buildAlterOptions(obj, id, obs.Detail)
			return &opts, nil
		}),
		ApplyObservationFn: func(obj *snowplanev1alpha1.StreamOnView, obs *reconciler.Observation[*snowflake.StreamObservation]) {
			applyObservation(obj, obs.Detail)
		},
		DetectDriftFn: func(obj *snowplanev1alpha1.StreamOnView, obs *reconciler.Observation[*snowflake.StreamObservation]) *drift.Result {
			return detectDrift(obj, obs.Detail)
		},
		PreReconcileFn: func(ctx context.Context, obj *snowplanev1alpha1.StreamOnView) error {
			...
			viewName, err := refresolver.PreReconcileSourceRef(ctx, c, recorder, obj,
		...
		SetupWatchesFn: func(ctx context.Context, mgr ctrl.Manager, bldr *builder.Builder) error {
			...
			bldr.Watches(
				...
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.StreamOnViewList{} }, ".spec.databaseRef.name", "listing stream-on-view for database watch")),
			)

			bldr.Watches(
				&snowplanev1alpha1.Schema{},
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.StreamOnViewList{} }, ".spec.schemaRef.name", "listing stream-on-view for schema watch")),
			)
			...
			bldr.Watches(
				...
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.StreamOnViewList{} }, ".spec.viewRef.name", "listing stream-on-view for view watch")),
			)
...
func validateImmutableFields(_ context.Context, obj *snowplanev1alpha1.StreamOnView) error {
...
func applyObservation(obj *snowplanev1alpha1.StreamOnView, obs *snowflake.StreamObservation) {
...
func buildCreateOptions(obj *snowplanev1alpha1.StreamOnView, id snowflake.SchemaObjectIdentifier) snowflake.CreateStreamOptions {
	return snowflake.CreateStreamOptions{
		Name:            id,
		SourceType:      snowflake.StreamSourceView,
		SourceName:      obj.Status.ViewName,
...
func detectDrift(obj *snowplanev1alpha1.StreamOnView, obs *snowflake.StreamObservation) *drift.Result {
	...
	if obs.ShowOutput != nil {
		...
		d.CompareStringValueFold("SOURCE", obj.Status.ViewName, obs.ShowOutput.TableName, true)
