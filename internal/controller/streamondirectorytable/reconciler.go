...
func computeUnsetFields(obj *snowplanev1alpha1.StreamOnDirectoryTable) []string {
...
func computeTrackedParameters(spec *snowplanev1alpha1.StreamOnDirectoryTableSpec) []string {
	var fields []string
