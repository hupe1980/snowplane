...
// adapter implements reconciler.ResourceAdapter for StreamOnDirectoryTable.
type adapter struct {
	client     sigs.Client
...
func (a *adapter) ResourceName() string  { return "streamondirectorytable" }
func (a *adapter) FinalizerName() string { return finalizerName }
func (a *adapter) NewObject() *snowplanev1alpha1.StreamOnDirectoryTable {
...
func (a *adapter) PreReconcile(ctx context.Context, obj *snowplanev1alpha1.StreamOnDirectoryTable) error {
...
func (a *adapter) BuildIdentifier(obj *snowplanev1alpha1.StreamOnDirectoryTable) (reconciler.Identifier, error) {
...
func (a *adapter) SetupWatches() reconciler.SetupWatchesFunc {
	return func(ctx context.Context, mgr ctrl.Manager, bldr *builder.Builder) error {
		...
		bldr.Watches(
			...
			handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(a.client, func() sigs.ObjectList { return &snowplanev1alpha1.StreamOnDirectoryTableList{} }, ".spec.databaseRef.name", "listing stream-on-directory-table for database watch")),
		)
...
func (a *adapter) Create(ctx context.Context, svc Service, obj *snowplanev1alpha1.StreamOnDirectoryTable, id reconciler.Identifier) error {
	sid, err := reconciler.AssertIdentifier[snowflake.SchemaObjectIdentifier](id)
	if err != nil {
		return err
	}
...
func (a *adapter) ValidateImmutableFields(_ context.Context, obj *snowplanev1alpha1.StreamOnDirectoryTable) error {
...
func (a *adapter) BuildAlterOptions(_ context.Context, obj *snowplanev1alpha1.StreamOnDirectoryTable, id reconciler.Identifier, obs *reconciler.Observation[*snowflake.StreamObservation]) (reconciler.AlterOptions, error) {
	sid, err := reconciler.AssertIdentifier[snowflake.SchemaObjectIdentifier](id)
	if err != nil {
		return nil, err
	}
...
func (a *adapter) ApplyObservation(obj *snowplanev1alpha1.StreamOnDirectoryTable, obs *reconciler.Observation[*snowflake.StreamObservation]) {
	detail := obs.Detail
	applyObservation(obj, detail)
}

func (a *adapter) ComputeTrackedParameters(obj *snowplanev1alpha1.StreamOnDirectoryTable) []string {
	return computeTrackedParameters(&obj.Spec)
}

func (a *adapter) DetectDrift(obj *snowplanev1alpha1.StreamOnDirectoryTable, obs *reconciler.Observation[*snowflake.StreamObservation]) *drift.Result {
	detail := obs.Detail
	return detectDrift(obj, detail)
}

var _ reconciler.ResourceAdapter[*snowplanev1alpha1.StreamOnDirectoryTable, Service, *snowflake.StreamObservation] = (*adapter)(nil)
