...
const (
	finalizerName = "snowplane.hupe1980.github.io/secretwithauthorizationcodegrant"
)
...
// NewReconciler returns a new SecretWithAuthorizationCodeGrant reconciler backed by the generic framework.
func NewReconciler(c sigs.Client, factory *clientfactory.ClientFactory, recorder record.EventRecorder, rl *ratelimit.Limiter) *reconciler.GenericReconciler[*snowplanev1alpha1.SecretWithAuthorizationCodeGrant, Service, *snowflake.SecretObservation] {
...
func NewReconcilerWithServiceFactory(
	...
	sf ServiceFactory,
) *reconciler.GenericReconciler[*snowplanev1alpha1.SecretWithAuthorizationCodeGrant, Service, *snowflake.SecretObservation] {
	return reconciler.NewGenericReconciler(c, factory, recorder, rl, newAdapter(c, recorder, sf))
}

// newAdapter creates the BaseAdapter for SecretWithAuthorizationCodeGrant resources.
func newAdapter(c sigs.Client, recorder record.EventRecorder, sf ServiceFactory) *reconciler.BaseAdapter[*snowplanev1alpha1.SecretWithAuthorizationCodeGrant, Service, *snowflake.SecretObservation] {
	return &reconciler.BaseAdapter[*snowplanev1alpha1.SecretWithAuthorizationCodeGrant, Service, *snowflake.SecretObservation]{
		ResourceNameVal:  "secretwithauthorizationcodegrant",
		FinalizerNameVal: finalizerName,
		NewObjectFn: func() *snowplanev1alpha1.SecretWithAuthorizationCodeGrant {
			return &snowplanev1alpha1.SecretWithAuthorizationCodeGrant{}
		},
		ServiceFactoryFn: sf,
		BuildIdentifierFn: func(obj *snowplanev1alpha1.SecretWithAuthorizationCodeGrant) (reconciler.Identifier, error) {
		...
		CreateFn: reconciler.MakeCreate(func(ctx context.Context, svc Service, obj *snowplanev1alpha1.SecretWithAuthorizationCodeGrant, id snowflake.SchemaObjectIdentifier) error {
		...
		BuildAlterOptsFn: reconciler.MakeBuildAlterOpts(func(_ context.Context, obj *snowplanev1alpha1.SecretWithAuthorizationCodeGrant, id snowflake.SchemaObjectIdentifier, obs *reconciler.Observation[*snowflake.SecretObservation]) (reconciler.AlterOptions, error) {
			opts := buildAlterOptions(obj, id, obs.Detail)
			return &opts, nil
		}),
		ApplyObservationFn: func(obj *snowplanev1alpha1.SecretWithAuthorizationCodeGrant, obs *reconciler.Observation[*snowflake.SecretObservation]) {
			applyObservation(obj, obs.Detail)
		},
		DetectDriftFn: func(obj *snowplanev1alpha1.SecretWithAuthorizationCodeGrant, obs *reconciler.Observation[*snowflake.SecretObservation]) *drift.Result {
			return detectDrift(obj, obs.Detail)
		},
		PreReconcileFn: func(ctx context.Context, obj *snowplanev1alpha1.SecretWithAuthorizationCodeGrant) error {
		...
		SetupWatchesFn: func(ctx context.Context, mgr ctrl.Manager, bldr *builder.Builder) error {
			...
			bldr.Watches(
				...
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.SecretWithAuthorizationCodeGrantList{} }, ".spec.databaseRef.name", "listing secrets for database watch")),
			)

			bldr.Watches(
				&snowplanev1alpha1.Schema{},
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.SecretWithAuthorizationCodeGrantList{} }, ".spec.schemaRef.name", "listing secrets for schema watch")),
			)
...
func validateImmutableFields(_ context.Context, obj *snowplanev1alpha1.SecretWithAuthorizationCodeGrant) error {
...
func applyObservation(obj *snowplanev1alpha1.SecretWithAuthorizationCodeGrant, obs *snowflake.SecretObservation) {
...
func buildCreateOptions(obj *snowplanev1alpha1.SecretWithAuthorizationCodeGrant, id snowflake.SchemaObjectIdentifier) snowflake.CreateSecretOptions {
	return snowflake.CreateSecretOptions{
		Name:                        id,
		SecretType:                  snowflake.SecretTypeOAuth2,
		APIAuthentication:           obj.Spec.APIAuthentication,
		OAuthRefreshToken:           obj.Spec.OAuthRefreshToken,
		OAuthRefreshTokenExpiryTime: obj.Spec.OAuthRefreshTokenExpiryTime,
		Comment:                     obj.Spec.Comment,
	}
}

func buildAlterOptions(obj *snowplanev1alpha1.SecretWithAuthorizationCodeGrant, id snowflake.SchemaObjectIdentifier, obs *snowflake.SecretObservation) snowflake.AlterSecretOptions {
	...
	refreshToken := obj.Spec.OAuthRefreshToken
	opts.OAuthRefreshToken = &refreshToken

	expiryTime := obj.Spec.OAuthRefreshTokenExpiryTime
	opts.OAuthRefreshTokenExpiryTime = &expiryTime
...
func detectDrift(obj *snowplanev1alpha1.SecretWithAuthorizationCodeGrant, obs *snowflake.SecretObservation) *drift.Result {
	d := drift.New()
