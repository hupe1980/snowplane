...
func lateInitialize(obj *snowplanev1alpha1.ResourceMonitor, obs *reconciler.Observation[*snowflake.ResourceMonitorObservation]) bool {
	detail := obs.Detail
...
var _ reconciler.LateInitializer[*snowplanev1alpha1.ResourceMonitor, *snowflake.ResourceMonitorObservation] = (*reconciler.BaseAdapter[*snowplanev1alpha1.ResourceMonitor, Service, *snowflake.ResourceMonitorObservation])(nil)
