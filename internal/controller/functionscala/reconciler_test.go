...
func newTestCR(name, namespace string) *snowplanev1alpha1.FunctionScala {
...
func newTestReconciler(mock *mockService, objs ...runtime.Object) *reconciler.GenericReconciler[*snowplanev1alpha1.FunctionScala, Service, *snowflake.FunctionObservation] {
	...
	return &reconciler.GenericReconciler[*snowplanev1alpha1.FunctionScala, Service, *snowflake.FunctionObservation]{
		Client:   c,
		Factory:  factory,
		Recorder: rec,
		Adapter: &adapter{
		...
		GVK: snowplanev1alpha1.GroupVersion.WithKind("FunctionScala"),
	}
}
