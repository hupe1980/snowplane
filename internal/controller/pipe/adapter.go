...
func (a *adapter) BuildIdentifier(pipe *snowplanev1alpha1.Pipe) reconciler.Identifier {
	...
	return snowflake.NewSchemaObjectIdentifier(dbName, schemaName, pipe.Spec.Name)
}
