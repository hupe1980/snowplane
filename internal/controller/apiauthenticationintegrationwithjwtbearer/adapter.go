...
func (a *adapter) ResourceName() string  { return "apiauthenticationintegrationwithjwtbearer" }
func (a *adapter) FinalizerName() string { return finalizerName }
func (a *adapter) NewObject() *snowplanev1alpha1.APIAuthenticationIntegrationWithJWTBearer {
...
func (a *adapter) BuildIdentifier(obj *snowplanev1alpha1.APIAuthenticationIntegrationWithJWTBearer) (reconciler.Identifier, error) {
...
func (a *adapter) Create(ctx context.Context, svc Service, obj *snowplanev1alpha1.APIAuthenticationIntegrationWithJWTBearer, id reconciler.Identifier) error {
	aid, err := reconciler.AssertIdentifier[snowflake.AccountObjectIdentifier](id)
	if err != nil {
		return err
	}
...
func (a *adapter) ValidateImmutableFields(_ context.Context, obj *snowplanev1alpha1.APIAuthenticationIntegrationWithJWTBearer) error {
...
func (a *adapter) BuildAlterOptions(_ context.Context, obj *snowplanev1alpha1.APIAuthenticationIntegrationWithJWTBearer, id reconciler.Identifier, obs *reconciler.Observation[*snowflake.APIAuthenticationIntegrationObservation]) (reconciler.AlterOptions, error) {
	aid, err := reconciler.AssertIdentifier[snowflake.AccountObjectIdentifier](id)
	if err != nil {
		return nil, err
	}
...
func (a *adapter) ApplyObservation(obj *snowplanev1alpha1.APIAuthenticationIntegrationWithJWTBearer, obs *reconciler.Observation[*snowflake.APIAuthenticationIntegrationObservation]) {
	applyObservation(obj, obs.Detail)
}

func (a *adapter) ComputeTrackedParameters(obj *snowplanev1alpha1.APIAuthenticationIntegrationWithJWTBearer) []string {
	return tracked.ComputeTracked(&obj.Spec)
}

func (a *adapter) DetectDrift(obj *snowplanev1alpha1.APIAuthenticationIntegrationWithJWTBearer, obs *reconciler.Observation[*snowflake.APIAuthenticationIntegrationObservation]) *drift.Result {
	return detectDrift(obj, obs.Detail)
}

var _ reconciler.ResourceAdapter[*snowplanev1alpha1.APIAuthenticationIntegrationWithJWTBearer, Service, *snowflake.APIAuthenticationIntegrationObservation] = (*adapter)(nil)
