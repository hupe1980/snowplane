...
func buildCreateOptions(obj *snowplanev1alpha1.APIAuthenticationIntegrationWithJWTBearer, id snowflake.AccountObjectIdentifier) snowflake.CreateAPIAuthenticationIntegrationOptions {
