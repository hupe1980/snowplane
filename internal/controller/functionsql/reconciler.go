// Package functionsql implements the reconciler for FunctionSQL resources.
package functionsql
...
const (
	finalizerName = "snowplane.hupe1980.github.io/functionsql"
)
...
// NewReconciler returns a new FunctionSQL reconciler backed by the generic framework.
func NewReconciler(c sigs.Client, factory *clientfactory.ClientFactory, recorder record.EventRecorder, rl *ratelimit.Limiter) *reconciler.GenericReconciler[*snowplanev1alpha1.FunctionSQL, Service, *snowflake.FunctionObservation] {
...
func NewReconcilerWithServiceFactory(
	...
	sf ServiceFactory,
) *reconciler.GenericReconciler[*snowplanev1alpha1.FunctionSQL, Service, *snowflake.FunctionObservation] {
	return reconciler.NewGenericReconciler(c, factory, recorder, rl, newAdapter(c, recorder, sf))
}

// newAdapter creates the BaseAdapter for FunctionSQL resources.
func newAdapter(c sigs.Client, recorder record.EventRecorder, sf ServiceFactory) *reconciler.BaseAdapter[*snowplanev1alpha1.FunctionSQL, Service, *snowflake.FunctionObservation] {
	return &reconciler.BaseAdapter[*snowplanev1alpha1.FunctionSQL, Service, *snowflake.FunctionObservation]{
		ResourceNameVal:  "functionsql",
		FinalizerNameVal: finalizerName,
		NewObjectFn:      func() *snowplanev1alpha1.FunctionSQL { return &snowplanev1alpha1.FunctionSQL{} },
		ServiceFactoryFn: sf,
		BuildIdentifierFn: func(obj *snowplanev1alpha1.FunctionSQL) (reconciler.Identifier, error) {
		...
		CreateFn: reconciler.MakeCreate(func(ctx context.Context, svc Service, obj *snowplanev1alpha1.FunctionSQL, id snowflake.CallableIdentifier) error {
		...
		BuildAlterOptsFn: reconciler.MakeBuildAlterOpts(func(_ context.Context, obj *snowplanev1alpha1.FunctionSQL, id snowflake.CallableIdentifier, obs *reconciler.Observation[*snowflake.FunctionObservation]) (reconciler.AlterOptions, error) {
			opts := buildAlterOptions(obj, id, obs.Detail)
			return &opts, nil
		}),
		ApplyObservationFn: func(obj *snowplanev1alpha1.FunctionSQL, obs *reconciler.Observation[*snowflake.FunctionObservation]) {
			applyObservation(obj, obs.Detail)
		},
		DetectDriftFn: func(obj *snowplanev1alpha1.FunctionSQL, obs *reconciler.Observation[*snowflake.FunctionObservation]) *drift.Result {
			return detectDrift(obj, obs.Detail)
		},
		SupportsCoA: true,
		PreReconcileFn: func(ctx context.Context, obj *snowplanev1alpha1.FunctionSQL) error {
		...
		SetupWatchesFn: func(ctx context.Context, mgr ctrl.Manager, bldr *builder.Builder) error {
			if err := mgr.GetFieldIndexer().IndexField(
				ctx,
				&snowplanev1alpha1.FunctionSQL{},
				".spec.databaseRef.name",
				func(o sigs.Object) []string {
					obj, ok := o.(*snowplanev1alpha1.FunctionSQL)
			...
			bldr.Watches(
				...
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.FunctionSQLList{} }, ".spec.databaseRef.name", "listing functionsqls for database watch")),
			)

			bldr.Watches(
				&snowplanev1alpha1.Schema{},
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.FunctionSQLList{} }, ".spec.schemaRef.name", "listing functionsqls for schema watch")),
			)
...
func validateImmutableFields(_ context.Context, obj *snowplanev1alpha1.FunctionSQL) error {
...
func applyObservation(obj *snowplanev1alpha1.FunctionSQL, obs *snowflake.FunctionObservation) {
...
func buildCreateOptions(obj *snowplanev1alpha1.FunctionSQL, id snowflake.CallableIdentifier) snowflake.CreateFunctionOptions {
...
func buildAlterOptions(obj *snowplanev1alpha1.FunctionSQL, id snowflake.CallableIdentifier, obs *snowflake.FunctionObservation) snowflake.AlterFunctionOptions {
...
func detectDrift(obj *snowplanev1alpha1.FunctionSQL, obs *snowflake.FunctionObservation) *drift.Result {
	d := drift.New()
