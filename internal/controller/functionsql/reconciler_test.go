...
func newTestCR(name, namespace string) *snowplanev1alpha1.FunctionSQL {
...
func newTestReconciler(mock *mockService, objs ...runtime.Object) *reconciler.GenericReconciler[*snowplanev1alpha1.FunctionSQL, Service, *snowflake.FunctionObservation] {
	...
	return &reconciler.GenericReconciler[*snowplanev1alpha1.FunctionSQL, Service, *snowflake.FunctionObservation]{
		...
		GVK: snowplanev1alpha1.GroupVersion.WithKind("FunctionSQL"),
	}
}
