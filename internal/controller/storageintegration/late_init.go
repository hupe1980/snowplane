...
func lateInitialize(obj *snowplanev1alpha1.StorageIntegration, obs *reconciler.Observation[*snowflake.StorageIntegrationObservation]) bool {
	detail := obs.Detail
...
var _ reconciler.LateInitializer[*snowplanev1alpha1.StorageIntegration, *snowflake.StorageIntegrationObservation] = (*reconciler.BaseAdapter[*snowplanev1alpha1.StorageIntegration, Service, *snowflake.StorageIntegrationObservation])(nil)
