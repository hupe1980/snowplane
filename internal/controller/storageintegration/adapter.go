...
func (a *adapter) PreReconcile(_ context.Context, _ *snowplanev1alpha1.StorageIntegration) error {
	return nil
}

func (a *adapter) BuildIdentifier(obj *snowplanev1alpha1.StorageIntegration) reconciler.Identifier {
...
func (a *adapter) PostCreate(_ *snowplanev1alpha1.StorageIntegration) {}
func (a *adapter) PostUpdate(_ *snowplanev1alpha1.StorageIntegration, _ bool, _ reconciler.AlterOptions) {
}
