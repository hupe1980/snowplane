...
func NewReconciler(c client.Client, factory *clientfactory.ClientFactory, recorder record.EventRecorder, rl *ratelimit.Limiter) *reconciler.GenericReconciler[*snowplanev1alpha1.Schema, Service] {
...
func NewReconcilerWithServiceFactory(
	...
	sf ServiceFactory,
) *reconciler.GenericReconciler[*snowplanev1alpha1.Schema, Service] {
