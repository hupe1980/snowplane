...
var _ reconciler.LateInitializer[*snowplanev1alpha1.Schema, *snowflake.SchemaObservation] = (*reconciler.BaseAdapter[*snowplanev1alpha1.Schema, Service, *snowflake.SchemaObservation])(nil)
