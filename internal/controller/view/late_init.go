...
func (a *adapter) LateInitialize(obj *snowplanev1alpha1.View, obs *reconciler.Observation[*snowflake.ViewObservation]) bool {
	detail := obs.Detail
...
var _ reconciler.LateInitializer[*snowplanev1alpha1.View, *snowflake.ViewObservation] = (*adapter)(nil)
