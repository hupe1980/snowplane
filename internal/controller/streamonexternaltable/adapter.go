...
// adapter implements reconciler.ResourceAdapter for StreamOnExternalTable.
type adapter struct {
	client     sigs.Client
...
func (a *adapter) ResourceName() string  { return "streamonexternaltable" }
func (a *adapter) FinalizerName() string { return finalizerName }
func (a *adapter) NewObject() *snowplanev1alpha1.StreamOnExternalTable {
...
func (a *adapter) PreReconcile(ctx context.Context, obj *snowplanev1alpha1.StreamOnExternalTable) error {
...
func (a *adapter) BuildIdentifier(obj *snowplanev1alpha1.StreamOnExternalTable) (reconciler.Identifier, error) {
...
func (a *adapter) Create(ctx context.Context, svc Service, obj *snowplanev1alpha1.StreamOnExternalTable, id reconciler.Identifier) error {
	sid, err := reconciler.AssertIdentifier[snowflake.SchemaObjectIdentifier](id)
	if err != nil {
		return err
	}
...
func (a *adapter) ValidateImmutableFields(_ context.Context, obj *snowplanev1alpha1.StreamOnExternalTable) error {
...
func (a *adapter) BuildAlterOptions(_ context.Context, obj *snowplanev1alpha1.StreamOnExternalTable, id reconciler.Identifier, obs *reconciler.Observation[*snowflake.StreamObservation]) (reconciler.AlterOptions, error) {
	sid, err := reconciler.AssertIdentifier[snowflake.SchemaObjectIdentifier](id)
	if err != nil {
		return nil, err
	}
...
func (a *adapter) ApplyObservation(obj *snowplanev1alpha1.StreamOnExternalTable, obs *reconciler.Observation[*snowflake.StreamObservation]) {
	detail := obs.Detail
	applyObservation(obj, detail)
}

func (a *adapter) ComputeTrackedParameters(obj *snowplanev1alpha1.StreamOnExternalTable) []string {
	return computeTrackedParameters(&obj.Spec)
}

func (a *adapter) DetectDrift(obj *snowplanev1alpha1.StreamOnExternalTable, obs *reconciler.Observation[*snowflake.StreamObservation]) *drift.Result {
	detail := obs.Detail
	return detectDrift(obj, detail)
}

var _ reconciler.ResourceAdapter[*snowplanev1alpha1.StreamOnExternalTable, Service, *snowflake.StreamObservation] = (*adapter)(nil)
