...
func NewReconciler(c client.Client, factory *clientfactory.ClientFactory, recorder record.EventRecorder, rl *ratelimit.Limiter) *reconciler.GenericReconciler[*snowplanev1alpha1.StreamOnExternalTable, Service, *snowflake.StreamObservation] {
...
func computeUnsetFields(obj *snowplanev1alpha1.StreamOnExternalTable) []string {
...
func computeTrackedParameters(spec *snowplanev1alpha1.StreamOnExternalTableSpec) []string {
	var fields []string
