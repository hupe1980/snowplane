...
func newTestCR(name, namespace string) *snowplanev1alpha1.FunctionJavascript {
...
func newTestReconciler(mock *mockService, objs ...runtime.Object) *reconciler.GenericReconciler[*snowplanev1alpha1.FunctionJavascript, Service, *snowflake.FunctionObservation] {
	...
	r.GVK = snowplanev1alpha1.GroupVersion.WithKind("FunctionJavascript")
