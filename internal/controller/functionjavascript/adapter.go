...
// adapter implements reconciler.ResourceAdapter for FunctionJavascript.
type adapter struct {
	client     sigs.Client
...
func (a *adapter) ResourceName() string  { return "functionjavascript" }
func (a *adapter) FinalizerName() string { return finalizerName }
func (a *adapter) NewObject() *snowplanev1alpha1.FunctionJavascript {
...
func (a *adapter) PreReconcile(ctx context.Context, obj *snowplanev1alpha1.FunctionJavascript) error {
...
func (a *adapter) BuildIdentifier(obj *snowplanev1alpha1.FunctionJavascript) (reconciler.Identifier, error) {
...
func (a *adapter) SetupWatches() reconciler.SetupWatchesFunc {
	return func(ctx context.Context, mgr ctrl.Manager, bldr *builder.Builder) error {
		...
		bldr.Watches(
			...
			handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(a.client, func() sigs.ObjectList { return &snowplanev1alpha1.FunctionJavascriptList{} }, ".spec.databaseRef.name", "listing functionjavascripts for database watch")),
		)

		bldr.Watches(
			&snowplanev1alpha1.Schema{},
			handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(a.client, func() sigs.ObjectList { return &snowplanev1alpha1.FunctionJavascriptList{} }, ".spec.schemaRef.name", "listing functionjavascripts for schema watch")),
		)
...
func (a *adapter) Create(ctx context.Context, svc Service, obj *snowplanev1alpha1.FunctionJavascript, id reconciler.Identifier) error {
	cid, err := reconciler.AssertIdentifier[snowflake.CallableIdentifier](id)
	if err != nil {
		return err
	}
...
func (a *adapter) ValidateImmutableFields(_ context.Context, obj *snowplanev1alpha1.FunctionJavascript) error {
...
func (a *adapter) BuildAlterOptions(_ context.Context, obj *snowplanev1alpha1.FunctionJavascript, id reconciler.Identifier, obs *reconciler.Observation[*snowflake.FunctionObservation]) (reconciler.AlterOptions, error) {
	cid, err := reconciler.AssertIdentifier[snowflake.CallableIdentifier](id)
	if err != nil {
		return nil, err
	}
...
func (a *adapter) ApplyObservation(obj *snowplanev1alpha1.FunctionJavascript, obs *reconciler.Observation[*snowflake.FunctionObservation]) {
	detail := obs.Detail
	applyObservation(obj, detail)
}

func (a *adapter) ComputeTrackedParameters(obj *snowplanev1alpha1.FunctionJavascript) []string {
	return tracked.ComputeTracked(&obj.Spec)
}

func (a *adapter) DetectDrift(obj *snowplanev1alpha1.FunctionJavascript, obs *reconciler.Observation[*snowflake.FunctionObservation]) *drift.Result {
	detail := obs.Detail
...
var _ reconciler.ResourceAdapter[*snowplanev1alpha1.FunctionJavascript, Service, *snowflake.FunctionObservation] = (*adapter)(nil)
