...
func NewReconciler(c sigs.Client, factory *clientfactory.ClientFactory, recorder record.EventRecorder, rl *ratelimit.Limiter) *reconciler.GenericReconciler[*snowplanev1alpha1.FunctionJavascript, Service, *snowflake.FunctionObservation] {
...
// newAdapter creates the BaseAdapter for FunctionJavascript resources.
func newAdapter(c sigs.Client, recorder record.EventRecorder, sf ServiceFactory) *reconciler.BaseAdapter[*snowplanev1alpha1.FunctionJavascript, Service, *snowflake.FunctionObservation] {
	return &reconciler.BaseAdapter[*snowplanev1alpha1.FunctionJavascript, Service, *snowflake.FunctionObservation]{
		ResourceNameVal:  "functionjavascript",
		FinalizerNameVal: finalizerName,
		NewObjectFn:      func() *snowplanev1alpha1.FunctionJavascript { return &snowplanev1alpha1.FunctionJavascript{} },
		ServiceFactoryFn: sf,
		BuildIdentifierFn: func(obj *snowplanev1alpha1.FunctionJavascript) (reconciler.Identifier, error) {
		...
		CreateFn: reconciler.MakeCreate(func(ctx context.Context, svc Service, obj *snowplanev1alpha1.FunctionJavascript, id snowflake.CallableIdentifier) error {
		...
		BuildAlterOptsFn: reconciler.MakeBuildAlterOpts(func(_ context.Context, obj *snowplanev1alpha1.FunctionJavascript, id snowflake.CallableIdentifier, obs *reconciler.Observation[*snowflake.FunctionObservation]) (reconciler.AlterOptions, error) {
			opts := buildAlterOptions(obj, id, obs.Detail)
			return &opts, nil
		}),
		ApplyObservationFn: func(obj *snowplanev1alpha1.FunctionJavascript, obs *reconciler.Observation[*snowflake.FunctionObservation]) {
			applyObservation(obj, obs.Detail)
		},
		DetectDriftFn: func(obj *snowplanev1alpha1.FunctionJavascript, obs *reconciler.Observation[*snowflake.FunctionObservation]) *drift.Result {
			return detectDrift(obj, obs.Detail)
		},
		SupportsCoA: true,
		PreReconcileFn: func(ctx context.Context, obj *snowplanev1alpha1.FunctionJavascript) error {
		...
		SetupWatchesFn: func(ctx context.Context, mgr ctrl.Manager, bldr *builder.Builder) error {
			if err := mgr.GetFieldIndexer().IndexField(
				ctx,
				&snowplanev1alpha1.FunctionJavascript{},
				".spec.databaseRef.name",
				func(o sigs.Object) []string {
					obj, ok := o.(*snowplanev1alpha1.FunctionJavascript)
			...
			bldr.Watches(
				...
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.FunctionJavascriptList{} }, ".spec.databaseRef.name", "listing functionjavascripts for database watch")),
			)

			bldr.Watches(
				&snowplanev1alpha1.Schema{},
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.FunctionJavascriptList{} }, ".spec.schemaRef.name", "listing functionjavascripts for schema watch")),
			)
...
func validateImmutableFields(_ context.Context, obj *snowplanev1alpha1.FunctionJavascript) error {
