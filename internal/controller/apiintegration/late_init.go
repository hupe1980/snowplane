...
func lateInitialize(obj *snowplanev1alpha1.APIIntegration, obs *reconciler.Observation[*snowflake.APIIntegrationObservation]) bool {
	detail := obs.Detail
...
var _ reconciler.LateInitializer[*snowplanev1alpha1.APIIntegration, *snowflake.APIIntegrationObservation] = (*reconciler.BaseAdapter[*snowplanev1alpha1.APIIntegration, Service, *snowflake.APIIntegrationObservation])(nil)
