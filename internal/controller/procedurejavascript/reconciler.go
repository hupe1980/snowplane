// Package procedurejavascript implements the reconciler for ProcedureJavascript resources.
...
const (
	finalizerName = "snowplane.hupe1980.github.io/procedurejavascript"
)
...
func buildCreateOptions(obj *snowplanev1alpha1.ProcedureJavascript, id snowflake.CallableIdentifier) snowflake.CreateProcedureOptions {
...
func buildAlterOptions(obj *snowplanev1alpha1.ProcedureJavascript, id snowflake.CallableIdentifier, obs *snowflake.ProcedureObservation) snowflake.AlterProcedureOptions {
...
func detectDrift(obj *snowplanev1alpha1.ProcedureJavascript, obs *snowflake.ProcedureObservation) *drift.Result {
	d := drift.New()
