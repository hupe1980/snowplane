...
func newTestCR(name, namespace string) *snowplanev1alpha1.ProcedureJavascript {
...
func newTestReconciler(mock *mockService, objs ...runtime.Object) *reconciler.GenericReconciler[*snowplanev1alpha1.ProcedureJavascript, Service, *snowflake.ProcedureObservation] {
	...
	r.GVK = snowplanev1alpha1.GroupVersion.WithKind("ProcedureJavascript")
