...
func (m *mockService) Observe(ctx context.Context, name snowflake.SchemaObjectIdentifier) (*snowflake.ExternalTableObservation, error) {
	if m.observeFn != nil {
...
func (m *mockService) Create(ctx context.Context, opts snowflake.CreateExternalTableOptions) error {
	if m.createFn != nil {
...
func (m *mockService) Alter(ctx context.Context, opts snowflake.AlterExternalTableOptions) error {
	if m.alterFn != nil {
...
func newTestExternalTable(name, namespace string) *snowplanev1alpha1.ExternalTable {
...
func newTestReconciler(mock *mockService, objs ...runtime.Object) *reconciler.GenericReconciler[*snowplanev1alpha1.ExternalTable, Service, *snowflake.ExternalTableObservation] {
	...
	r.GVK = snowplanev1alpha1.GroupVersion.WithKind("ExternalTable")
...
func TestReconcile_StandardSuite(t *testing.T) {
	...
	testutil.ReconcileSuiteConfig{
		...
		NewFixture: func(name, ns string) client.Object {
			return newTestExternalTable(name, ns)
		},
