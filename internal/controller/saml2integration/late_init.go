...
func lateInitialize(obj *snowplanev1alpha1.SAML2Integration, obs *reconciler.Observation[*snowflake.SAML2IntegrationObservation]) bool {
	detail := obs.Detail
...
var _ reconciler.LateInitializer[*snowplanev1alpha1.SAML2Integration, *snowflake.SAML2IntegrationObservation] = (*reconciler.BaseAdapter[*snowplanev1alpha1.SAML2Integration, Service, *snowflake.SAML2IntegrationObservation])(nil)
