...
type mockService struct {
	observeFn func(ctx context.Context, name snowflake.SchemaObjectIdentifier) (*snowflake.InternalStageObservation, error)
	createFn  func(ctx context.Context, opts snowflake.CreateInternalStageOptions) error
	alterFn   func(ctx context.Context, opts snowflake.AlterInternalStageOptions) error
	dropFn    func(ctx context.Context, name snowflake.SchemaObjectIdentifier) error
}

func (m *mockService) Observe(ctx context.Context, name snowflake.SchemaObjectIdentifier) (*snowflake.InternalStageObservation, error) {
	if m.observeFn != nil {
		return m.observeFn(ctx, name)
	}
	return &snowflake.InternalStageObservation{Exists: false}, nil
}

func (m *mockService) Create(ctx context.Context, opts snowflake.CreateInternalStageOptions) error {
	if m.createFn != nil {
...
func (m *mockService) Alter(ctx context.Context, opts snowflake.AlterInternalStageOptions) error {
	if m.alterFn != nil {
...
func newTestInternalStage(name, ns string) *snowplanev1alpha1.InternalStage {
...
func newTestReconciler(mock *mockService, objs ...runtime.Object) *reconciler.GenericReconciler[*snowplanev1alpha1.InternalStage, Service, *snowflake.InternalStageObservation] {
	...
	r.GVK = snowplanev1alpha1.GroupVersion.WithKind("InternalStage")
...
func TestReconcile_StandardSuite(t *testing.T) {
	...
	testutil.ReconcileSuiteConfig{
		...
		NewFixture: func(name, ns string) client.Object {
			return newTestInternalStage(name, ns)
		},
