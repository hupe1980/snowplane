// Package procedurescala implements the reconciler for ProcedureScala resources.
...
const (
	finalizerName = "snowplane.hupe1980.github.io/procedurescala"
)
...
// NewReconciler returns a new ProcedureScala reconciler backed by the generic framework.
func NewReconciler(c sigs.Client, factory *clientfactory.ClientFactory, recorder record.EventRecorder, rl *ratelimit.Limiter) *reconciler.GenericReconciler[*snowplanev1alpha1.ProcedureScala, Service, *snowflake.ProcedureObservation] {
...
func NewReconcilerWithServiceFactory(
	...
	sf ServiceFactory,
) *reconciler.GenericReconciler[*snowplanev1alpha1.ProcedureScala, Service, *snowflake.ProcedureObservation] {
	return reconciler.NewGenericReconciler(c, factory, recorder, rl, newAdapter(c, recorder, sf))
}

// newAdapter creates the BaseAdapter for ProcedureScala resources.
func newAdapter(c sigs.Client, recorder record.EventRecorder, sf ServiceFactory) *reconciler.BaseAdapter[*snowplanev1alpha1.ProcedureScala, Service, *snowflake.ProcedureObservation] {
	return &reconciler.BaseAdapter[*snowplanev1alpha1.ProcedureScala, Service, *snowflake.ProcedureObservation]{
		ResourceNameVal:  "procedurescala",
		FinalizerNameVal: finalizerName,
		NewObjectFn:      func() *snowplanev1alpha1.ProcedureScala { return &snowplanev1alpha1.ProcedureScala{} },
		ServiceFactoryFn: sf,
		BuildIdentifierFn: func(obj *snowplanev1alpha1.ProcedureScala) (reconciler.Identifier, error) {
		...
		CreateFn: reconciler.MakeCreate(func(ctx context.Context, svc Service, obj *snowplanev1alpha1.ProcedureScala, id snowflake.CallableIdentifier) error {
		...
		BuildAlterOptsFn: reconciler.MakeBuildAlterOpts(func(_ context.Context, obj *snowplanev1alpha1.ProcedureScala, id snowflake.CallableIdentifier, obs *reconciler.Observation[*snowflake.ProcedureObservation]) (reconciler.AlterOptions, error) {
			opts := buildAlterOptions(obj, id, obs.Detail)
			return &opts, nil
		}),
		ApplyObservationFn: func(obj *snowplanev1alpha1.ProcedureScala, obs *reconciler.Observation[*snowflake.ProcedureObservation]) {
			applyObservation(obj, obs.Detail)
		},
		DetectDriftFn: func(obj *snowplanev1alpha1.ProcedureScala, obs *reconciler.Observation[*snowflake.ProcedureObservation]) *drift.Result {
			return detectDrift(obj, obs.Detail)
		},
		SupportsCoA: true,
		PreReconcileFn: func(ctx context.Context, obj *snowplanev1alpha1.ProcedureScala) error {
		...
		SetupWatchesFn: func(ctx context.Context, mgr ctrl.Manager, bldr *builder.Builder) error {
			if err := mgr.GetFieldIndexer().IndexField(
				ctx,
				&snowplanev1alpha1.ProcedureScala{},
				".spec.databaseRef.name",
				func(o sigs.Object) []string {
					obj, ok := o.(*snowplanev1alpha1.ProcedureScala)
			...
			bldr.Watches(
				...
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.ProcedureScalaList{} }, ".spec.databaseRef.name", "listing procedurescalas for database watch")),
			)

			bldr.Watches(
				&snowplanev1alpha1.Schema{},
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.ProcedureScalaList{} }, ".spec.schemaRef.name", "listing procedurescalas for schema watch")),
			)
...
func validateImmutableFields(_ context.Context, obj *snowplanev1alpha1.ProcedureScala) error {
...
func applyObservation(obj *snowplanev1alpha1.ProcedureScala, obs *snowflake.ProcedureObservation) {
...
func buildCreateOptions(obj *snowplanev1alpha1.ProcedureScala, id snowflake.CallableIdentifier) snowflake.CreateProcedureOptions {
...
func buildAlterOptions(obj *snowplanev1alpha1.ProcedureScala, id snowflake.CallableIdentifier, obs *snowflake.ProcedureObservation) snowflake.AlterProcedureOptions {
...
func detectDrift(obj *snowplanev1alpha1.ProcedureScala, obs *snowflake.ProcedureObservation) *drift.Result {
	d := drift.New()
