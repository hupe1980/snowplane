...
func newTestCR(name, namespace string) *snowplanev1alpha1.ProcedureScala {
...
func newTestReconciler(mock *mockService, objs ...runtime.Object) *reconciler.GenericReconciler[*snowplanev1alpha1.ProcedureScala, Service, *snowflake.ProcedureObservation] {
	...
	return &reconciler.GenericReconciler[*snowplanev1alpha1.ProcedureScala, Service, *snowflake.ProcedureObservation]{
		...
		GVK: snowplanev1alpha1.GroupVersion.WithKind("ProcedureScala"),
	}
}
