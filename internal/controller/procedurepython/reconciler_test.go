...
func (m *mockService) Observe(ctx context.Context, name snowflake.SchemaObjectIdentifier, argTypes []string) (*snowflake.ProcedureObservation, error) {
	if m.observeFn != nil {
...
func (m *mockService) Create(ctx context.Context, opts snowflake.CreateProcedureOptions) error {
	if m.createFn != nil {
...
func (m *mockService) Alter(ctx context.Context, opts snowflake.AlterProcedureOptions) error {
	if m.alterFn != nil {
...
func newTestCR(name, namespace string) *snowplanev1alpha1.ProcedurePython {
...
func newTestReconciler(mock *mockService, objs ...runtime.Object) *reconciler.GenericReconciler[*snowplanev1alpha1.ProcedurePython, Service, *snowflake.ProcedureObservation] {
	...
	return &reconciler.GenericReconciler[*snowplanev1alpha1.ProcedurePython, Service, *snowflake.ProcedureObservation]{
		...
		GVK: snowplanev1alpha1.GroupVersion.WithKind("ProcedurePython"),
	}
}
