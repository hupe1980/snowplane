// Package procedurepython implements the reconciler for ProcedurePython resources.
...
const (
	finalizerName = "snowplane.hupe1980.github.io/procedurepython"
)
...
// NewReconciler returns a new ProcedurePython reconciler backed by the generic framework.
func NewReconciler(c sigs.Client, factory *clientfactory.ClientFactory, recorder record.EventRecorder, rl *ratelimit.Limiter) *reconciler.GenericReconciler[*snowplanev1alpha1.ProcedurePython, Service, *snowflake.ProcedureObservation] {
...
func NewReconcilerWithServiceFactory(
	...
	sf ServiceFactory,
) *reconciler.GenericReconciler[*snowplanev1alpha1.ProcedurePython, Service, *snowflake.ProcedureObservation] {
	return reconciler.NewGenericReconciler(c, factory, recorder, rl, newAdapter(c, recorder, sf))
}

// newAdapter creates the BaseAdapter for ProcedurePython resources.
func newAdapter(c sigs.Client, recorder record.EventRecorder, sf ServiceFactory) *reconciler.BaseAdapter[*snowplanev1alpha1.ProcedurePython, Service, *snowflake.ProcedureObservation] {
	return &reconciler.BaseAdapter[*snowplanev1alpha1.ProcedurePython, Service, *snowflake.ProcedureObservation]{
		ResourceNameVal:  "procedurepython",
		FinalizerNameVal: finalizerName,
		NewObjectFn:      func() *snowplanev1alpha1.ProcedurePython { return &snowplanev1alpha1.ProcedurePython{} },
		ServiceFactoryFn: sf,
		BuildIdentifierFn: func(obj *snowplanev1alpha1.ProcedurePython) (reconciler.Identifier, error) {
		...
		CreateFn: reconciler.MakeCreate(func(ctx context.Context, svc Service, obj *snowplanev1alpha1.ProcedurePython, id snowflake.CallableIdentifier) error {
		...
		BuildAlterOptsFn: reconciler.MakeBuildAlterOpts(func(_ context.Context, obj *snowplanev1alpha1.ProcedurePython, id snowflake.CallableIdentifier, obs *reconciler.Observation[*snowflake.ProcedureObservation]) (reconciler.AlterOptions, error) {
			opts := buildAlterOptions(obj, id, obs.Detail)
			return &opts, nil
		}),
		ApplyObservationFn: func(obj *snowplanev1alpha1.ProcedurePython, obs *reconciler.Observation[*snowflake.ProcedureObservation]) {
			applyObservation(obj, obs.Detail)
		},
		DetectDriftFn: func(obj *snowplanev1alpha1.ProcedurePython, obs *reconciler.Observation[*snowflake.ProcedureObservation]) *drift.Result {
			return detectDrift(obj, obs.Detail)
		},
		SupportsCoA: true,
		PreReconcileFn: func(ctx context.Context, obj *snowplanev1alpha1.ProcedurePython) error {
		...
		SetupWatchesFn: func(ctx context.Context, mgr ctrl.Manager, bldr *builder.Builder) error {
			if err := mgr.GetFieldIndexer().IndexField(
				ctx,
				&snowplanev1alpha1.ProcedurePython{},
				".spec.databaseRef.name",
				func(o sigs.Object) []string {
					obj, ok := o.(*snowplanev1alpha1.ProcedurePython)
			...
			bldr.Watches(
				...
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.ProcedurePythonList{} }, ".spec.databaseRef.name", "listing procedurepythons for database watch")),
			)

			bldr.Watches(
				&snowplanev1alpha1.Schema{},
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.ProcedurePythonList{} }, ".spec.schemaRef.name", "listing procedurepythons for schema watch")),
			)
...
func validateImmutableFields(_ context.Context, obj *snowplanev1alpha1.ProcedurePython) error {
...
func applyObservation(obj *snowplanev1alpha1.ProcedurePython, obs *snowflake.ProcedureObservation) {
...
func buildCreateOptions(obj *snowplanev1alpha1.ProcedurePython, id snowflake.CallableIdentifier) snowflake.CreateProcedureOptions {
...
func buildAlterOptions(obj *snowplanev1alpha1.ProcedurePython, id snowflake.CallableIdentifier, obs *snowflake.ProcedureObservation) snowflake.AlterProcedureOptions {
...
func detectDrift(obj *snowplanev1alpha1.ProcedurePython, obs *snowflake.ProcedureObservation) *drift.Result {
	d := drift.New()
