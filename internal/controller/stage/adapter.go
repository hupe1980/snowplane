...
func (a *adapter) BuildIdentifier(stage *snowplanev1alpha1.Stage) reconciler.Identifier {
	...
	return snowflake.NewSchemaObjectIdentifier(dbName, schemaName, stage.Spec.Name)
}
...
func (a *adapter) BuildAlterOptions(_ context.Context, obj *snowplanev1alpha1.Stage, id reconciler.Identifier, obs *reconciler.Observation) (reconciler.AlterOptions, error) {
	sid, err := reconciler.AssertIdentifier[snowflake.SchemaObjectIdentifier](id)
	if err != nil {
		return nil, err
	}

	detail, err := reconciler.AssertDetail[*snowflake.StageObservation](obs)
	if err != nil {
		return nil, err
	}
...
func (a *adapter) ApplyObservation(obj *snowplanev1alpha1.Stage, obs *reconciler.Observation) {
	detail, ok := obs.Detail.(*snowflake.StageObservation)
	if !ok {
		return
	}
...
func (a *adapter) DetectDrift(obj *snowplanev1alpha1.Stage, obs *reconciler.Observation) *drift.Result {
	detail, ok := obs.Detail.(*snowflake.StageObservation)
	if !ok {
...
func (a *adapter) PostCreate(_ *snowplanev1alpha1.Stage)                                    {}
func (a *adapter) PostUpdate(_ *snowplanev1alpha1.Stage, _ bool, _ reconciler.AlterOptions) {}

func (a *adapter) SupportsCreateOrAlter() bool { return false }

var _ reconciler.ResourceAdapter[*snowplanev1alpha1.Stage, Service] = (*adapter)(nil)
