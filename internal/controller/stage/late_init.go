...
func (a *adapter) LateInitialize(obj *snowplanev1alpha1.Stage, obs *reconciler.Observation[*snowflake.StageObservation]) bool {
	detail := obs.Detail
...
var _ reconciler.LateInitializer[*snowplanev1alpha1.Stage, *snowflake.StageObservation] = (*adapter)(nil)
