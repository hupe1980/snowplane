...
func (a *adapter) LateInitialize(obj *snowplanev1alpha1.Database, obs *reconciler.Observation[*snowflake.DatabaseObservation]) bool {
	detail := obs.Detail
	if detail == nil {
		return false
	}
...
var _ reconciler.LateInitializer[*snowplanev1alpha1.Database, *snowflake.DatabaseObservation] = (*adapter)(nil)
