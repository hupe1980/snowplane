...
func (m *mockService) Observe(ctx context.Context, name snowflake.AccountObjectIdentifier) (*snowflake.ExternalVolumeObservation, error) {
	if m.observeFn != nil {
...
func (m *mockService) Create(ctx context.Context, opts snowflake.CreateExternalVolumeOptions) error {
	if m.createFn != nil {
...
func (m *mockService) Alter(ctx context.Context, opts snowflake.AlterExternalVolumeOptions) error {
	if m.alterFn != nil {
...
func newTestExternalVolume(name, ns string) *snowplanev1alpha1.ExternalVolume {
...
func newTestReconciler(mock *mockService, objs ...runtime.Object) *reconciler.GenericReconciler[*snowplanev1alpha1.ExternalVolume, Service, *snowflake.ExternalVolumeObservation] {
	...
	r.GVK = snowplanev1alpha1.GroupVersion.WithKind("ExternalVolume")
...
func TestReconcile_StandardSuite(t *testing.T) {
	...
	testutil.ReconcileSuiteConfig{
		...
		NewFixture: func(name, ns string) client.Object {
			return newTestExternalVolume(name, ns)
		},
