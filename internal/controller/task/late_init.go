...
func (a *adapter) LateInitialize(obj *snowplanev1alpha1.Task, obs *reconciler.Observation[*snowflake.TaskObservation]) bool {
	detail := obs.Detail
	if detail == nil {
		return false
	}
...
var _ reconciler.LateInitializer[*snowplanev1alpha1.Task, *snowflake.TaskObservation] = (*adapter)(nil)
