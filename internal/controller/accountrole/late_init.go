...
func (a *adapter) LateInitialize(obj *snowplanev1alpha1.AccountRole, obs *reconciler.Observation[*snowflake.AccountRoleObservation]) bool {
	detail := obs.Detail
...
var _ reconciler.LateInitializer[*snowplanev1alpha1.AccountRole, *snowflake.AccountRoleObservation] = (*adapter)(nil)
