...
func newTestCR(name, namespace string) *snowplanev1alpha1.ProcedureJava {
...
func newTestReconciler(mock *mockService, objs ...runtime.Object) *reconciler.GenericReconciler[*snowplanev1alpha1.ProcedureJava, Service, *snowflake.ProcedureObservation] {
	...
	r.GVK = snowplanev1alpha1.GroupVersion.WithKind("ProcedureJava")
