...
// adapter implements reconciler.ResourceAdapter for ProcedureJava.
type adapter struct {
	client     sigs.Client
...
func (a *adapter) ResourceName() string  { return "procedurejava" }
func (a *adapter) FinalizerName() string { return finalizerName }
func (a *adapter) NewObject() *snowplanev1alpha1.ProcedureJava {
...
func (a *adapter) PreReconcile(ctx context.Context, obj *snowplanev1alpha1.ProcedureJava) error {
...
func (a *adapter) BuildIdentifier(obj *snowplanev1alpha1.ProcedureJava) (reconciler.Identifier, error) {
...
func (a *adapter) SetupWatches() reconciler.SetupWatchesFunc {
	return func(ctx context.Context, mgr ctrl.Manager, bldr *builder.Builder) error {
		if err := mgr.GetFieldIndexer().IndexField(
			ctx,
			&snowplanev1alpha1.ProcedureJava{},
			".spec.databaseRef.name",
			func(o sigs.Object) []string {
				obj, ok := o.(*snowplanev1alpha1.ProcedureJava)
		...
		bldr.Watches(
			...
			handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(a.client, func() sigs.ObjectList { return &snowplanev1alpha1.ProcedureJavaList{} }, ".spec.databaseRef.name", "listing procedurejavas for database watch")),
		)

		bldr.Watches(
			&snowplanev1alpha1.Schema{},
			handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(a.client, func() sigs.ObjectList { return &snowplanev1alpha1.ProcedureJavaList{} }, ".spec.schemaRef.name", "listing procedurejavas for schema watch")),
		)
...
func (a *adapter) Create(ctx context.Context, svc Service, obj *snowplanev1alpha1.ProcedureJava, id reconciler.Identifier) error {
	cid, err := reconciler.AssertIdentifier[snowflake.CallableIdentifier](id)
	if err != nil {
		return err
	}
...
func (a *adapter) ValidateImmutableFields(_ context.Context, obj *snowplanev1alpha1.ProcedureJava) error {
...
func (a *adapter) BuildAlterOptions(_ context.Context, obj *snowplanev1alpha1.ProcedureJava, id reconciler.Identifier, obs *reconciler.Observation[*snowflake.ProcedureObservation]) (reconciler.AlterOptions, error) {
	cid, err := reconciler.AssertIdentifier[snowflake.CallableIdentifier](id)
	if err != nil {
		return nil, err
	}
...
func (a *adapter) ApplyObservation(obj *snowplanev1alpha1.ProcedureJava, obs *reconciler.Observation[*snowflake.ProcedureObservation]) {
	detail := obs.Detail
	applyObservation(obj, detail)
}

func (a *adapter) ComputeTrackedParameters(obj *snowplanev1alpha1.ProcedureJava) []string {
	return tracked.ComputeTracked(&obj.Spec)
}

func (a *adapter) DetectDrift(obj *snowplanev1alpha1.ProcedureJava, obs *reconciler.Observation[*snowflake.ProcedureObservation]) *drift.Result {
	detail := obs.Detail
...
var _ reconciler.ResourceAdapter[*snowplanev1alpha1.ProcedureJava, Service, *snowflake.ProcedureObservation] = (*adapter)(nil)
