...
func NewReconciler(c sigs.Client, factory *clientfactory.ClientFactory, recorder record.EventRecorder, rl *ratelimit.Limiter) *reconciler.GenericReconciler[*snowplanev1alpha1.ProcedureJava, Service, *snowflake.ProcedureObservation] {
...
// newAdapter creates the BaseAdapter for ProcedureJava resources.
func newAdapter(c sigs.Client, recorder record.EventRecorder, sf ServiceFactory) *reconciler.BaseAdapter[*snowplanev1alpha1.ProcedureJava, Service, *snowflake.ProcedureObservation] {
	return &reconciler.BaseAdapter[*snowplanev1alpha1.ProcedureJava, Service, *snowflake.ProcedureObservation]{
		ResourceNameVal:  "procedurejava",
		FinalizerNameVal: finalizerName,
		NewObjectFn:      func() *snowplanev1alpha1.ProcedureJava { return &snowplanev1alpha1.ProcedureJava{} },
		ServiceFactoryFn: sf,
		BuildIdentifierFn: func(obj *snowplanev1alpha1.ProcedureJava) (reconciler.Identifier, error) {
		...
		CreateFn: reconciler.MakeCreate(func(ctx context.Context, svc Service, obj *snowplanev1alpha1.ProcedureJava, id snowflake.CallableIdentifier) error {
		...
		BuildAlterOptsFn: reconciler.MakeBuildAlterOpts(func(_ context.Context, obj *snowplanev1alpha1.ProcedureJava, id snowflake.CallableIdentifier, obs *reconciler.Observation[*snowflake.ProcedureObservation]) (reconciler.AlterOptions, error) {
			opts := buildAlterOptions(obj, id, obs.Detail)
			return &opts, nil
		}),
		ApplyObservationFn: func(obj *snowplanev1alpha1.ProcedureJava, obs *reconciler.Observation[*snowflake.ProcedureObservation]) {
			applyObservation(obj, obs.Detail)
		},
		DetectDriftFn: func(obj *snowplanev1alpha1.ProcedureJava, obs *reconciler.Observation[*snowflake.ProcedureObservation]) *drift.Result {
			return detectDrift(obj, obs.Detail)
		},
		SupportsCoA: true,
		PreReconcileFn: func(ctx context.Context, obj *snowplanev1alpha1.ProcedureJava) error {
		...
		SetupWatchesFn: func(ctx context.Context, mgr ctrl.Manager, bldr *builder.Builder) error {
			...
			bldr.Watches(
				...
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.ProcedureJavaList{} }, ".spec.databaseRef.name", "listing procedurejavas for database watch")),
			)

			bldr.Watches(
				&snowplanev1alpha1.Schema{},
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.ProcedureJavaList{} }, ".spec.schemaRef.name", "listing procedurejavas for schema watch")),
			)
...
func validateImmutableFields(_ context.Context, obj *snowplanev1alpha1.ProcedureJava) error {
