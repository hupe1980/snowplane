// Package apiauthenticationintegrationwithauthorizationcodegrant implements the reconciler for
// APIAuthenticationIntegrationWithAuthorizationCodeGrant resources.
...
const (
	finalizerName = "snowplane.hupe1980.github.io/apiauthenticationintegrationwithauthorizationcodegrant"
)
...
func detectDrift(obj *snowplanev1alpha1.APIAuthenticationIntegrationWithAuthorizationCodeGrant, obs *snowflake.APIAuthenticationIntegrationObservation) *drift.Result {
	d := drift.New()
