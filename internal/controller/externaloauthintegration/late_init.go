...
func lateInitialize(obj *snowplanev1alpha1.ExternalOAuthIntegration, obs *reconciler.Observation[*snowflake.ExternalOAuthIntegrationObservation]) bool {
	detail := obs.Detail
...
var _ reconciler.LateInitializer[*snowplanev1alpha1.ExternalOAuthIntegration, *snowflake.ExternalOAuthIntegrationObservation] = (*reconciler.BaseAdapter[*snowplanev1alpha1.ExternalOAuthIntegration, Service, *snowflake.ExternalOAuthIntegrationObservation])(nil)
