...
func (a *adapter) ResourceName() string  { return "secretwithgenericstring" }
func (a *adapter) FinalizerName() string { return finalizerName }
func (a *adapter) NewObject() *snowplanev1alpha1.SecretWithGenericString {
...
func (a *adapter) PreReconcile(ctx context.Context, obj *snowplanev1alpha1.SecretWithGenericString) error {
...
func (a *adapter) BuildIdentifier(obj *snowplanev1alpha1.SecretWithGenericString) (reconciler.Identifier, error) {
...
func (a *adapter) SetupWatches() reconciler.SetupWatchesFunc {
	return func(ctx context.Context, mgr ctrl.Manager, bldr *builder.Builder) error {
		...
		bldr.Watches(&snowplanev1alpha1.Database{},
			handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(a.client, func() sigs.ObjectList { return &snowplanev1alpha1.SecretWithGenericStringList{} }, ".spec.databaseRef.name", "listing secrets for database watch")))
		bldr.Watches(&snowplanev1alpha1.Schema{},
			handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(a.client, func() sigs.ObjectList { return &snowplanev1alpha1.SecretWithGenericStringList{} }, ".spec.schemaRef.name", "listing secrets for schema watch")))
...
func (a *adapter) Create(ctx context.Context, svc Service, obj *snowplanev1alpha1.SecretWithGenericString, id reconciler.Identifier) error {
	sid, err := reconciler.AssertIdentifier[snowflake.SchemaObjectIdentifier](id)
	if err != nil {
		return err
	}
...
func (a *adapter) ValidateImmutableFields(_ context.Context, obj *snowplanev1alpha1.SecretWithGenericString) error {
...
func (a *adapter) BuildAlterOptions(_ context.Context, obj *snowplanev1alpha1.SecretWithGenericString, id reconciler.Identifier, obs *reconciler.Observation[*snowflake.SecretObservation]) (reconciler.AlterOptions, error) {
	sid, err := reconciler.AssertIdentifier[snowflake.SchemaObjectIdentifier](id)
	if err != nil {
		return nil, err
	}
...
func (a *adapter) ApplyObservation(obj *snowplanev1alpha1.SecretWithGenericString, obs *reconciler.Observation[*snowflake.SecretObservation]) {
	applyObservation(obj, obs.Detail)
}

func (a *adapter) ComputeTrackedParameters(obj *snowplanev1alpha1.SecretWithGenericString) []string {
	return tracked.ComputeTracked(&obj.Spec)
}

func (a *adapter) DetectDrift(obj *snowplanev1alpha1.SecretWithGenericString, obs *reconciler.Observation[*snowflake.SecretObservation]) *drift.Result {
	return detectDrift(obj, obs.Detail)
}

var _ reconciler.ResourceAdapter[*snowplanev1alpha1.SecretWithGenericString, Service, *snowflake.SecretObservation] = (*adapter)(nil)
