...
func newTestSecret(name, namespace string) *snowplanev1alpha1.SecretWithGenericString {
...
func newTestReconciler(mock *mockService, objs ...runtime.Object) *reconciler.GenericReconciler[*snowplanev1alpha1.SecretWithGenericString, Service, *snowflake.SecretObservation] {
	scheme := testutil.TestScheme()

	cb := fake.NewClientBuilder().WithScheme(scheme).
		WithStatusSubresource(&snowplanev1alpha1.SecretWithGenericString{}, &snowplanev1alpha1.ProviderConfig{})
...
func TestReconcile_Create(t *testing.T) {
	...
	assert.Equal(t, snowflake.SecretTypeGenericString, capturedOpts.SecretType)
	assert.Equal(t, "my-secret-value", capturedOpts.SecretString)

	got := &snowplanev1alpha1.SecretWithGenericString{}
...
func TestBuildCreateOptions(t *testing.T) {
	...
	assert.Equal(t, snowflake.SecretTypeGenericString, opts.SecretType)
	assert.Equal(t, "my-secret-value", opts.SecretString)
}
...
func TestDetectDrift_NoDrift(t *testing.T) {
	...
	obj := &snowplanev1alpha1.SecretWithGenericString{
		Spec: snowplanev1alpha1.SecretWithGenericStringSpec{
			Name: "MY_SECRET",
		},
	}
