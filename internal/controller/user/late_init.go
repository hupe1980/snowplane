...
func lateInitialize(obj *snowplanev1alpha1.User, obs *reconciler.Observation[*snowflake.UserObservation]) bool {
	detail := obs.Detail
...
var _ reconciler.LateInitializer[*snowplanev1alpha1.User, *snowflake.UserObservation] = (*reconciler.BaseAdapter[*snowplanev1alpha1.User, Service, *snowflake.UserObservation])(nil)
