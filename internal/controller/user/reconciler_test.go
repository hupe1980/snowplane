...
func newTestReconciler(mock *mockService, objs ...runtime.Object) *reconciler.GenericReconciler[*snowplanev1alpha1.User, Service] {
...
func TestReconcile_UseRole_PassedToServiceFactory(t *testing.T) {
	...
	r := &reconciler.GenericReconciler[*snowplanev1alpha1.User, Service]{
		Client:   kClient,
		Factory:  clientfactory.NewClientFactory(),
		Recorder: rec,
		Adapter: &adapter{
