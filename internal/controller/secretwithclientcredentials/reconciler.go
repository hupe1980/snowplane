...
// NewReconciler returns a new SecretWithClientCredentials reconciler backed by the generic framework.
func NewReconciler(c sigs.Client, factory *clientfactory.ClientFactory, recorder record.EventRecorder, rl *ratelimit.Limiter) *reconciler.GenericReconciler[*snowplanev1alpha1.SecretWithClientCredentials, Service, *snowflake.SecretObservation] {
...
func NewReconcilerWithServiceFactory(
	...
	sf ServiceFactory,
) *reconciler.GenericReconciler[*snowplanev1alpha1.SecretWithClientCredentials, Service, *snowflake.SecretObservation] {
	return reconciler.NewGenericReconciler(c, factory, recorder, rl, newAdapter(c, recorder, sf))
}

// newAdapter creates the BaseAdapter for SecretWithClientCredentials resources.
func newAdapter(c sigs.Client, recorder record.EventRecorder, sf ServiceFactory) *reconciler.BaseAdapter[*snowplanev1alpha1.SecretWithClientCredentials, Service, *snowflake.SecretObservation] {
	return &reconciler.BaseAdapter[*snowplanev1alpha1.SecretWithClientCredentials, Service, *snowflake.SecretObservation]{
		ResourceNameVal:  "secretwithclientcredentials",
		FinalizerNameVal: finalizerName,
		NewObjectFn: func() *snowplanev1alpha1.SecretWithClientCredentials {
			return &snowplanev1alpha1.SecretWithClientCredentials{}
		},
		ServiceFactoryFn: sf,
		BuildIdentifierFn: func(obj *snowplanev1alpha1.SecretWithClientCredentials) (reconciler.Identifier, error) {
		...
		CreateFn: reconciler.MakeCreate(func(ctx context.Context, svc Service, obj *snowplanev1alpha1.SecretWithClientCredentials, id snowflake.SchemaObjectIdentifier) error {
		...
		BuildAlterOptsFn: reconciler.MakeBuildAlterOpts(func(_ context.Context, obj *snowplanev1alpha1.SecretWithClientCredentials, id snowflake.SchemaObjectIdentifier, obs *reconciler.Observation[*snowflake.SecretObservation]) (reconciler.AlterOptions, error) {
			opts := buildAlterOptions(obj, id, obs.Detail)
			return &opts, nil
		}),
		ApplyObservationFn: func(obj *snowplanev1alpha1.SecretWithClientCredentials, obs *reconciler.Observation[*snowflake.SecretObservation]) {
			applyObservation(obj, obs.Detail)
		},
		DetectDriftFn: func(obj *snowplanev1alpha1.SecretWithClientCredentials, obs *reconciler.Observation[*snowflake.SecretObservation]) *drift.Result {
			return detectDrift(obj, obs.Detail)
		},
		PreReconcileFn: func(ctx context.Context, obj *snowplanev1alpha1.SecretWithClientCredentials) error {
		...
		SetupWatchesFn: func(ctx context.Context, mgr ctrl.Manager, bldr *builder.Builder) error {
			if err := mgr.GetFieldIndexer().IndexField(
				ctx,
				&snowplanev1alpha1.SecretWithClientCredentials{},
				".spec.databaseRef.name",
				func(o sigs.Object) []string {
					obj, ok := o.(*snowplanev1alpha1.SecretWithClientCredentials)
			...
			bldr.Watches(
				...
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.SecretWithClientCredentialsList{} }, ".spec.databaseRef.name", "listing secrets for database watch")),
			)

			bldr.Watches(
				&snowplanev1alpha1.Schema{},
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.SecretWithClientCredentialsList{} }, ".spec.schemaRef.name", "listing secrets for schema watch")),
			)
...
func validateImmutableFields(_ context.Context, obj *snowplanev1alpha1.SecretWithClientCredentials) error {
