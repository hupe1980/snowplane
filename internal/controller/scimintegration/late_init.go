...
func lateInitialize(obj *snowplanev1alpha1.SCIMIntegration, obs *reconciler.Observation[*snowflake.SCIMIntegrationObservation]) bool {
	detail := obs.Detail
...
var _ reconciler.LateInitializer[*snowplanev1alpha1.SCIMIntegration, *snowflake.SCIMIntegrationObservation] = (*reconciler.BaseAdapter[*snowplanev1alpha1.SCIMIntegration, Service, *snowflake.SCIMIntegrationObservation])(nil)
