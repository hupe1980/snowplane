...
func newTestStreamOnDynamicTable(name, namespace string) *snowplanev1alpha1.StreamOnDynamicTable {
...
func newTestReconciler(mock *mockService, objs ...runtime.Object) *reconciler.GenericReconciler[*snowplanev1alpha1.StreamOnDynamicTable, Service, *snowflake.StreamObservation] {
	scheme := testutil.TestScheme()
	cb := fake.NewClientBuilder().WithScheme(scheme).
		WithStatusSubresource(&snowplanev1alpha1.StreamOnDynamicTable{}, &snowplanev1alpha1.ProviderConfig{})
	...
	return &reconciler.GenericReconciler[*snowplanev1alpha1.StreamOnDynamicTable, Service, *snowflake.StreamObservation]{
		...
		GVK: snowplanev1alpha1.GroupVersion.WithKind("StreamOnDynamicTable"),
	}
}
...
func TestReconcile_StandardSuite(t *testing.T) {
	...
	testutil.ReconcileSuiteConfig{
		...
		NewFixture: func(name, ns string) client.Object {
			return newTestStreamOnDynamicTable(name, ns)
		},
...
func TestReconcile_Create(t *testing.T) {
	...
	assert.Equal(t, snowflake.StreamSourceDynamicTable, capturedOpts.SourceType)
	assert.Equal(t, "MY_DYN_TABLE", capturedOpts.SourceName)
	got := &snowplanev1alpha1.StreamOnDynamicTable{}
...
func TestBuildCreateOptions(t *testing.T) {
	...
	assert.Equal(t, snowflake.StreamSourceDynamicTable, opts.SourceType)
	assert.Equal(t, "MY_DYN_TABLE", opts.SourceName)
...
func TestDetectDrift_NoDrift(t *testing.T) {
	...
	s := &snowplanev1alpha1.StreamOnDynamicTable{
		Spec:   snowplanev1alpha1.StreamOnDynamicTableSpec{Name: "MY_STREAM", DynamicTable: "MY_DYN_TABLE"},
		Status: snowplanev1alpha1.StreamOnDynamicTableStatus{DatabaseName: "MY_DB", SchemaName: "MY_SCHEMA"},
	}
	obs := &snowflake.StreamObservation{
		ShowOutput: &snowflake.StreamShowOutput{
			Name: "MY_STREAM", DatabaseName: "MY_DB", SchemaName: "MY_SCHEMA",
			TableName: "MY_DYN_TABLE", Mode: "DEFAULT",
		},
	}
...
func TestDetectDrift_WithDrift(t *testing.T) {
	t.Parallel()
	s := &snowplanev1alpha1.StreamOnDynamicTable{
		Spec:   snowplanev1alpha1.StreamOnDynamicTableSpec{Name: "MY_STREAM", DynamicTable: "MY_DYN_TABLE", Comment: testutil.PtrString("desired")},
		Status: snowplanev1alpha1.StreamOnDynamicTableStatus{DatabaseName: "MY_DB", SchemaName: "MY_SCHEMA"},
	}
	obs := &snowflake.StreamObservation{
		ShowOutput: &snowflake.StreamShowOutput{
			Name: "MY_STREAM", DatabaseName: "MY_DB", SchemaName: "MY_SCHEMA",
			TableName: "MY_DYN_TABLE", Comment: "drifted", Mode: "DEFAULT",
		},
	}
	result := detectDrift(s, obs)
