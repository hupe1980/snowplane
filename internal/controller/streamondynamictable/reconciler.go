...
func NewReconciler(c sigs.Client, factory *clientfactory.ClientFactory, recorder record.EventRecorder, rl *ratelimit.Limiter) *reconciler.GenericReconciler[*snowplanev1alpha1.StreamOnDynamicTable, Service, *snowflake.StreamObservation] {
...
// newAdapter creates the BaseAdapter for StreamOnDynamicTable resources.
func newAdapter(c sigs.Client, recorder record.EventRecorder, sf ServiceFactory) *reconciler.BaseAdapter[*snowplanev1alpha1.StreamOnDynamicTable, Service, *snowflake.StreamObservation] {
	return &reconciler.BaseAdapter[*snowplanev1alpha1.StreamOnDynamicTable, Service, *snowflake.StreamObservation]{
		ResourceNameVal:  "streamondynamictable",
		FinalizerNameVal: finalizerName,
		NewObjectFn:      func() *snowplanev1alpha1.StreamOnDynamicTable { return &snowplanev1alpha1.StreamOnDynamicTable{} },
		ServiceFactoryFn: sf,
		BuildIdentifierFn: func(obj *snowplanev1alpha1.StreamOnDynamicTable) (reconciler.Identifier, error) {
		...
		CreateFn: reconciler.MakeCreate(func(ctx context.Context, svc Service, obj *snowplanev1alpha1.StreamOnDynamicTable, id snowflake.SchemaObjectIdentifier) error {
		...
		BuildAlterOptsFn: reconciler.MakeBuildAlterOpts(func(_ context.Context, obj *snowplanev1alpha1.StreamOnDynamicTable, id snowflake.SchemaObjectIdentifier, obs *reconciler.Observation[*snowflake.StreamObservation]) (reconciler.AlterOptions, error) {
			opts := buildAlterOptions(obj, id, obs.Detail)
			return &opts, nil
		}),
		ApplyObservationFn: func(obj *snowplanev1alpha1.StreamOnDynamicTable, obs *reconciler.Observation[*snowflake.StreamObservation]) {
			applyObservation(obj, obs.Detail)
		},
		DetectDriftFn: func(obj *snowplanev1alpha1.StreamOnDynamicTable, obs *reconciler.Observation[*snowflake.StreamObservation]) *drift.Result {
			return detectDrift(obj, obs.Detail)
		},
		PreReconcileFn: func(ctx context.Context, obj *snowplanev1alpha1.StreamOnDynamicTable) error {
			...
			dynamicTableName, err := refresolver.PreReconcileSourceRef(ctx, c, recorder, obj,
			...
			obj.Status.DynamicTableName = dynamicTableName
		...
		SetupWatchesFn: func(ctx context.Context, mgr ctrl.Manager, bldr *builder.Builder) error {
			...
			bldr.Watches(
				...
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.StreamOnDynamicTableList{} }, ".spec.databaseRef.name", "listing stream-on-dynamic-table for database watch")),
			)

			bldr.Watches(
				&snowplanev1alpha1.Schema{},
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.StreamOnDynamicTableList{} }, ".spec.schemaRef.name", "listing stream-on-dynamic-table for schema watch")),
			)
			...
			bldr.Watches(
				...
				handler.EnqueueRequestsFromMapFunc(refresolver.MapByFieldIndex(c, func() sigs.ObjectList { return &snowplanev1alpha1.StreamOnDynamicTableList{} }, ".spec.dynamicTableRef.name", "listing stream-on-dynamic-table for dynamic-table watch")),
			)
...
func validateImmutableFields(_ context.Context, obj *snowplanev1alpha1.StreamOnDynamicTable) error {
...
func buildCreateOptions(obj *snowplanev1alpha1.StreamOnDynamicTable, id snowflake.SchemaObjectIdentifier) snowflake.CreateStreamOptions {
	return snowflake.CreateStreamOptions{
		...
		SourceName:      obj.Status.DynamicTableName,
...
func detectDrift(obj *snowplanev1alpha1.StreamOnDynamicTable, obs *snowflake.StreamObservation) *drift.Result {
	...
	if obs.ShowOutput != nil {
		...
		d.CompareStringValueFold("SOURCE", obj.Status.DynamicTableName, obs.ShowOutput.TableName, true)
