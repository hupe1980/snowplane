...
func newTestCR(name, namespace string) *snowplanev1alpha1.ProcedureSQL {
...
func newTestReconciler(mock *mockService, objs ...runtime.Object) *reconciler.GenericReconciler[*snowplanev1alpha1.ProcedureSQL, Service, *snowflake.ProcedureObservation] {
	...
	return &reconciler.GenericReconciler[*snowplanev1alpha1.ProcedureSQL, Service, *snowflake.ProcedureObservation]{
		...
		GVK: snowplanev1alpha1.GroupVersion.WithKind("ProcedureSQL"),
	}
}
