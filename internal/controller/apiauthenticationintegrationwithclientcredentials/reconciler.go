...
func buildCreateOptions(obj *snowplanev1alpha1.APIAuthenticationIntegrationWithClientCredentials, id snowflake.AccountObjectIdentifier) snowflake.CreateAPIAuthenticationIntegrationOptions {
