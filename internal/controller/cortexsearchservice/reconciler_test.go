...
func (m *mockService) Observe(ctx context.Context, name snowflake.SchemaObjectIdentifier) (*snowflake.CortexSearchServiceObservation, error) {
	if m.observeFn != nil {
...
func (m *mockService) Create(ctx context.Context, opts snowflake.CreateCortexSearchServiceOptions) error {
	if m.createFn != nil {
...
func (m *mockService) Alter(ctx context.Context, opts snowflake.AlterCortexSearchServiceOptions) error {
	if m.alterFn != nil {
...
func newTestCortexSearchService(name, ns string) *snowplanev1alpha1.CortexSearchService {
	return &snowplanev1alpha1.CortexSearchService{
		...
		Spec: snowplanev1alpha1.CortexSearchServiceSpec{
			...
			WarehouseRef: &snowplanev1alpha1.ObjectReference{Name: "compute-wh"},
			On:           "text_col",
			TargetLag:    "1 hour",
...
func newTestWarehouse(name, ns string) *snowplanev1alpha1.Warehouse {
	wh := &snowplanev1alpha1.Warehouse{
		...
		Status: snowplanev1alpha1.WarehouseStatus{
			CommonStatus: snowplanev1alpha1.CommonStatus{
				FullyQualifiedName: `"COMPUTE_WH"`,
				ObservedGeneration: 1,
			},
		},
	}
	conditions.SetReady(wh, "ok")
	return wh
}

func newTestReconciler(mock *mockService, objs ...runtime.Object) *reconciler.GenericReconciler[*snowplanev1alpha1.CortexSearchService, Service, *snowflake.CortexSearchServiceObservation] {
	...
	r.GVK = snowplanev1alpha1.GroupVersion.WithKind("CortexSearchService")
...
func TestReconcile_StandardSuite(t *testing.T) {
	...
	testutil.ReconcileSuiteConfig{
		...
		NewFixture: func(name, ns string) client.Object {
			return newTestCortexSearchService(name, ns)
		},
		...
		PrereqObjects: func() []runtime.Object {
			return []runtime.Object{
				...
				newTestWarehouse("compute-wh", "default"),
			}
		},
	}.Run(t)
}
